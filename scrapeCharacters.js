...
const scrapeUnreleasedCharacters = () => {
  return new Promise((resolve, reject) => {
    const options = {
      url: 'https://genshin.honeyhunterworld.com/db/char/unreleased-and-upcoming-characters/'
    }
...
const scrapeCharacters = () => {
  return new Promise(async (resolve, reject) => {
    console.log('Scraping Live Characters')
    await scrapeLiveCharacters()
    console.log('Scraping Unreleased Characters')
